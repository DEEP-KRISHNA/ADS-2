...
/******************************************************************************
 *  Compilation:  javac TrieDST.java
 *  Execution:    java TrieDST < words.txt
...
/**
 * The {@code TrieDST} class represents an symbol table of key-value pairs, with
...
public class TrieDST<Value> {
    private int n; // size
    public Node<Value> root; // root of TrieDST
    ...
    /**
     * Unit tests the {@code TrieDST} data type.
     *
    ...
    // TrieDST<Integer> st = new TrieDST<Integer>();
